            ...
            <div class="col-md-8">
                ...
                <div class="search">
                     <i class="fa fa-search"></i>
                      <input type="text" class="form-control" name="searchid" placeholder="Enter the Car Model"> 
                      
                    </div>

                    <div class="search">
                        <i class="fa fa-search"></i>
                         <input type="text" name="searchminp" class="form-control" placeholder="Enter the Min Price"> 
                         
                       </div>
                       <div class="search">
                        <i class="fa fa-search"></i>
                         <input type="text" name="searchmaxp" class="form-control" placeholder="Enter the Max Price "> 
